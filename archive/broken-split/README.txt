...
----------------------------------
Just keep all 4 files together in the same folder.
Do not separate index.html from styles.css or game.js.
...
- js/setup-pathing.js
- js/waves-combat.js
- js/abilities-boot.js
- archive/ (old backups and the previous single-file game.js)

Run the game by opening index.html. The files in archive/ are not loaded by the game.
